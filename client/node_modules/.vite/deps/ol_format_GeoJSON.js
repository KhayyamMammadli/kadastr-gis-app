import { n as abstract } from "./Object-BRew6XkJ.js";
import { n as isEmpty } from "./obj-CCV9u-q6.js";
import Feature from "./ol_Feature.js";
import { m as equivalent, x as getTransform, y as get } from "./proj-9HgmLmRq.js";
import { _ as deflateCoordinatesArray, b as getLayoutForStride, v as deflateMultiCoordinatesArray } from "./simplify-DSRo0YGI.js";
import { t as LineString } from "./LineString-DkFZcYYZ.js";
import { i as MultiLineString, n as MultiPolygon, r as MultiPoint, t as RenderFeature } from "./Feature-9PHImOY8.js";
import { c as linearRingssAreOriented, l as orientLinearRings, m as Point, s as linearRingsAreOriented, t as Polygon, u as orientLinearRingsArray } from "./Polygon-Bq2_5cWZ.js";
import { t as GeometryCollection } from "./GeometryCollection-B5iWGMUH.js";
 ...
 /**
	...
	*/
	readProjectionFromObject(object) {
		...
		let projection;
		if (crs) if (crs["type"] == "name") projection = get(crs["properties"]["name"]);
		else if (crs["type"] === "EPSG") projection = get("EPSG:" + crs["properties"]["code"]);
	...
	*/
	writeFeatureObject(feature, options) {
		...
		if (!isEmpty(properties)) object.properties = properties;
		return object;
	}
	/**
