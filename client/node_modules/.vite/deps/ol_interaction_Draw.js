import { o as BaseEvent } from "./Object-BRew6XkJ.js";
import { m as EventType_default, n as TRUE, t as FALSE } from "./functions-B1eIyX_V.js";
import { S as MapBrowserEventType_default, d as never, f as noModifierKeys, i as always, v as shiftKeyOnly } from "./condition-BVEzSPTR.js";
import Feature from "./ol_Feature.js";
import { C as getUserProjection, Ct as intersects, U as squaredDistance, bt as getTopLeft, ft as getBottomLeft, g as fromUserCoordinate, nt as createOrUpdate, pt as getBottomRight, q as boundingExtent, ut as forEachCorner, xt as getTopRight, z as distance } from "./proj-9HgmLmRq.js";
import { h as deflateCoordinate, w as rotate, x as getStrideForLayout, y as SimpleGeometry } from "./simplify-DSRo0YGI.js";
import { t as LineString } from "./LineString-DkFZcYYZ.js";
import { i as MultiLineString, n as MultiPolygon, r as MultiPoint } from "./Feature-9PHImOY8.js";
import { a as makeRegular, m as Point, r as fromCircle, t as Polygon } from "./Polygon-Bq2_5cWZ.js";
import { t as MapBrowserEvent } from "./MapBrowserEvent-DEBzFHMQ.js";
import { i as createEditingStyle } from "./Text-DO9ZTEGI.js";
import { t as VectorLayer } from "./Vector-BQ7Tzong.js";
import { t as VectorSource } from "./Vector-DaFWul8J.js";
import { i as Property_default } from "./Interaction-MqCys-BR.js";
import { t as PointerInteraction } from "./Pointer-CXz3WYyi.js";
import { i as interpolateCoordinate, n as getTraceTargetUpdate, r as getTraceTargets, t as getCoordinate } from "./tracing-CMNh8fOn.js";
//#region node_modules/ol/geom/Circle.js
/**
...
* @api
*/
var Circle = class Circle extends SimpleGeometry {
	/**
	...
	*/
	constructor(center, radius, layout) {
		super();
		if (layout !== void 0 && radius === void 0) this.setFlatCoordinates(layout, center);
		else {
	...
	*/
	intersectsExtent(extent) {
		if (intersects(extent, this.getExtent())) {
 ...
 /**
			...
			*/
			geometryFunction = (coordinates, geometry, projection) => {
				...
				const squaredLength = squaredDistance(center, fromUserCoordinate(coordinates[coordinates.length - 1], projection));
...
function createRegularPolygon(sides, angle) {
	return function(coordinates, geometry, projection) {
		...
		makeRegular(geometry, center, radius, internalAngle);
		const userProjection = getUserProjection();
...
//#endregion
export { DrawEvent, createBox, createRegularPolygon, Draw as default };
