...
import { o as BaseEvent, r as getUid } from "./Object-BRew6XkJ.js";
import { n as TRUE, u as extend } from "./functions-B1eIyX_V.js";
import { d as never, v as shiftKeyOnly, y as singleClick } from "./condition-BVEzSPTR.js";
...
import { t as Interaction } from "./Interaction-MqCys-BR.js";
//#region node_modules/ol/interaction/Select.js
/**
...
* this type.
*/
var SelectEvent = class extends BaseEvent {
	/**
...
* @api
*/
var Select = class Select extends Interaction {
	/**
	...
	*/
	constructor(options) {
		...
		*/
		...
		let layerFilter;
		if (options.layers) if (typeof options.layers === "function") layerFilter = options.layers;
		else {
	...
	*/
	setMap(map) {
		if (this.getMap() && this.style_) this.features_.forEach(this.restorePreviousStyle_.bind(this));
		super.setMap(map);
		if (map) {
	...
	*/
	findLayerOfFeature_(feature) {
		return this.getMap().getAllLayers().find(function(layer) {
	...
	*/
	selectFeature(feature) {
		const layer = this.findLayerOfFeature_(feature);
		if (!this.layerFilter_(layer) || !this.filter_(feature, layer)) return false;
		const features = this.getFeatures();
		if (features.getArray().includes(feature)) return false;
		this.addFeatureLayerAssociation_(feature, layer);
		features.push(feature);
		this.dispatchEvent(new SelectEvent(SelectEventType.SELECT, [feature], [], void 0));
		return true;
	}
	/**
	...
	*/
	toggleFeature(feature) {
		if (!this.deselectFeature(feature)) this.selectFeature(feature);
	}
	/**
	...
	*/
	clearSelection() {
		...
		if (features.getLength() !== 0) {
			...
			features.clear();
			this.dispatchEvent(new SelectEvent(SelectEventType.SELECT, [], deselected, void 0));
		}
	}
	/**
		...
		*/
		...
		if (set) {
			...
			map.forEachFeatureAtPixel(mapBrowserEvent.pixel, (feature, layer) => {
				...
				if (hasFeature && (remove || toggle)) deselected.push(feature);
...
//#endregion
export { SelectEvent, Select as default };

//# sourceMappingURL=ol_interaction_Select.js.map